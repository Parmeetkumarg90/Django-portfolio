...
document.getElementsByClassName("work-buttons")[0].addEventListener("click", () => {
    document.getElementsByClassName("work-data")[0].firstElementChild.setAttribute("src","/static/images/profile1.jpg");
    document.getElementsByClassName("work-data")[0].firstElementChild.setAttribute("alt", "my_image");
